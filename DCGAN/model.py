...
#    print(self.y_dim)
    ...
    if self.dataset_name == 'kaggle':
      self.data_X, self.data_y = self.load_kaggle()
      self.c_dim = self.data_X[0].shape[-1]
      self.data_X = self.data_X[:,1:73,1:73,:]
    else:
  ...
  def build_model(self):
    ...
    print(tf.shape(self.D))
    print(tf.shape(self.D_logits))

    self.sampler            = self.sampler(self.z, self.y)
    print(tf.shape(self.sampler))


    self.D_, self.D_logits_ = self.discriminator(self.G, self.y, reuse=True)
    print(tf.shape(self.D_))
    print(tf.shape(self.D_logits_))
  ...
  def train(self, config):
    ...
    for epoch in xrange(config.epoch):
      if (config.dataset == 'mnist' or config.dataset == 'kaggle'):
...
#    te_band_1 = np.load('C://Users//yzhu16//.spyder-py3//te_band_1.npy')
#    te_band_2 = np.load('C://Users//yzhu16//.spyder-py3//te_band_2.npy')
...
#    te_ang = np.load('C://Users//yzhu16//.spyder-py3//te_ang.npy')
    ...
    # FOR Kaggle, we don't have tru labels!!
#    teX = trX
    teY = trY
...
#      y_vec[i,y[i]] = 1.0
    y_vec = tr_label_  # direclt using my method for 2-classes one-hot matrix!
