# -*- coding: utf-8 -*-
"""
Created on Sun Dec 30 16:35:23 2017
...
df_train = pd.read_json('D:/FinalProj/train.json') # a dataframe
...
file_path="Wts-{epoch:02d}-{val_acc:.4f}-kaggleuser.hdf5" #  added part
...
model.load_weights(filepath = 'Wts-43-1.0000-kaggleuser.hdf5')
...
submission.to_csv('submission_12302017_kaggleuser_1.csv', index=False)
